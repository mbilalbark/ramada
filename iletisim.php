                ...
                <div class="contact-container">
                    <div class="contact-address">
                        <div class="contact-adress-item">
                            <i class="icon_set_1_icon-41 contact-icon"></i>
                        </div>
                        <div class="contact-adress-item">
                            <div class="contact-address-header">
                                Adres
                            </div>
                            <div class="contact-address-info">
                                Güllük Mah. Adnan Menderes Cad. No:145 Adapazarı / Sakarya
                            </div>
                            <div class="contact-adrress-phone">
                                Tel: 0264 666 22 44
                            </div>
                            <div class="contact-adrress-phone">
                                Fax: 0264 282 44 44
                    ...
                    <form class="contact-form">
                        <div class="contact-form-item">
                            <div class="form-item-detail">
                                ...
                                <input class="form-input" placeholder="Tam Adiniz"/>
                            </div>
                        </div>
                        <div class="contact-form-item">
                            <div class="form-item-detail">
                                <label class="form-label" >Email</label>
                                <input class="form-input" placeholder="Email Adresiniz"/>
                            </div>
                            <div class="form-item-detail">
                                <label class="form-label" >Telefon</label>
                                <input class="form-input" placeholder="Telefon Numaraniz"/>
                            </div>
                        </div>
                        <div class="contact-form-item">
                            <div class="form-item-detail">
                                <label class="form-label" >Mesaj</label>
                                <textarea class="form-input" rows="4" cols="50" placeholder="Mesajiniz"></textarea>
                            </div>
                        </div>
